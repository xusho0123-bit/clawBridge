...
- [ ] 修復 Bug #1: polling fallback 加入權限偵測
- [ ] 修復 Bug #2: `useStreaming` 改為 per-cascade 或加重試
- [ ] 修復 Bug #3: 等權限時暫停/延長 timeout
- [ ] 修復 Bug #4: replay 權限追蹤 + 重新檢查機制
- [ ] 調查 Bug #5: 加入更多 log 追蹤重複回應的確切原因
- [ ] 加入 unit test 覆蓋 polling + permission 場景
